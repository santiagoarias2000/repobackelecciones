...
const sql_update_1 = require("./../../repo/personRepository/sql_update");
const UpdateDAO_1 = __importDefault(require("../../dao/personDAO/UpdateDAO"));
class PersonControllerUpdate extends UpdateDAO_1.default {
    updatePerson(req, res) {
        ...
        PersonControllerUpdate.updatePerson(sql_update_1.SQL_PERSON_UPDATE.CONFIRMPERSON, sql_update_1.SQL_PERSON_UPDATE.UPDATE, parameter, res);
    }
}
const personControllerUpdate = new PersonControllerUpdate();
exports.default = personControllerUpdate;
